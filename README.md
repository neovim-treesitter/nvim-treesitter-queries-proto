# nvim-treesitter-queries-proto

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-proto/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-proto/actions/workflows/validate.yml)

Neovim tree-sitter queries for **proto**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-proto",
...
- [ ] Changes are scoped to `proto` — do not include files for other languages
